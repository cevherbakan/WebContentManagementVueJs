<template>
  ...
  <div class="carousel-inner">
    <div v-for="(img_item, i) in images" :key="i" :class="{'active':true, 'active':(i == 0)}"  class="carousel-item">
 <img style="max-width:250px;margin:auto;" class="d-block w-100" :src="img_base_url + img_item.img_url" alt="First slide">
    </div>
...
export default {
  ...
  behavior: 'smooth'
    ...
    let dataUrl = store.state.base_url + "OurProject/getByIdOurProject.php?key=123";
    axios
    ...
    dataUrl = store.state.base_url + "OurProjectImage/getForOurProjectImage.php?key=123";
    axios
